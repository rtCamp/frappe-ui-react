...
import type { EditorCommand } from "../../menu/commands/types";
import { YoutubeIcon } from "lucide-react";

export const InsertIframe: EditorCommand["component"] = ({ editor }) => {
  ...
  const customWidth = optimalDimensions.width;
  const customHeight = optimalDimensions.height;
