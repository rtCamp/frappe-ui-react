...
export function getCalendarDates(month: number, year: number): Date[] {
  ...
  const datesTillNow: Date[] = [
    ...datesInPreviousMonth,
    ...datesInCurrentMonth,
  ];
  ...
  function getCurrentMonthDates(date: Date): Date[] {
    ...
    const allDates: Date[] = getDatesAfter(
  ...
  function getBeforeDates(firstDay: Date, leftPadding: number): Date[] {
    ...
    for (let i = 0; i < leftPadding; i++) {
      allDates.push(
        new Date(firstDay.getFullYear(), firstDay.getMonth(), 0 - i)
      );
    }
  ...
  function getNextMonthDates(currentAndPreviousMonthDates: Date[]): Date[] {
    const numberofDaysInCalendar: number =
...
export function parseDateWithComma(
  date: Date,
...
): (CalendarEvent & { hallNumber: number; idx: number })[] {
...
export const colorMap: ColorMap = {
  blue: {
    background_color: "bg-surface-blue-2",
    border_color: "border-surface-blue-3",
  },
  green: {
    background_color: "bg-surface-green-2",
    border_color: "border-surface-green-3",
  },
  red: {
    background_color: "bg-surface-red-3",
    border_color: "border-surface-red-4",
  },
  orange: {
    background_color: "bg-surface-orange-1",
    border_color: "border-surface-orange-2",
  },
  yellow: {
    background_color: "bg-surface-yellow-1",
    border_color: "border-surface-yellow-2",
  },
  teal: {
    background_color: "bg-surface-teal-1",
    border_color: "border-surface-teal-2",
  },
  violet: {
    background_color: "bg-surface-violet-1",
    border_color: "border-surface-violet-2",
  },
  cyan: {
    background_color: "bg-surface-cyan-1",
    border_color: "border-surface-cyan-2",
  },
  purple: {
    background_color: "bg-surface-purple-1",
    border_color: "border-surface-purple-2",
  },
  pink: {
    background_color: "bg-surface-pink-1",
    border_color: "border-surface-pink-2",
  },
  amber: {
    background_color: "bg-surface-amber-1",
    border_color: "border-surface-amber-3",
  },
};
