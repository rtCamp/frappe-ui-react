...
const Divider = ({
  ...
  return action ? (
    <div className={clsx('relative whitespace-nowrap border-0 border-outline-gray-2', alignmentClasses)}>
    ...
    <hr className={clsx('relative whitespace-nowrap border-0 border-outline-gray-2', alignmentClasses)} />
  );
};
